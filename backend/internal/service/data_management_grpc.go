...
type DataManagementGoldenDBConfig struct {
...
type DataManagementConfig struct {
	...
	ActiveGoldenDBID  string                       `json:"active_goldendb_profile_id"`
	ActiveRedisID     string                       `json:"active_redis_profile_id"`
	GoldenDB          DataManagementGoldenDBConfig `json:"goldendb"`
...
type DataManagementBackupJob struct {
	...
	GoldenDBID     string                     `json:"goldendb_profile_id,omitempty"`
