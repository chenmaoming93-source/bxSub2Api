export default {
  ...
  auth: {
    ...
    accountLabel: '账号',
    accountPlaceholder: '请输入邮箱或 LDAP 用户名',
    passwordLabel: '密码',
  ...
  admin: {
    ...
    users: {
      ...
      failedToLoadApiKeys: '加载用户 API 密钥失败',
       syncLDAP: '同步 LDAP 用户信息',
       syncLDAPLoading: '同步 LDAP 中...',
       syncLDAPSuccess: 'LDAP 用户同步完成：已同步 {synced}/{total} 个用户',
       syncLDAPPartialSuccess: 'LDAP 用户同步完成：已同步 {synced}/{total} 个用户，{failed} 个失败或未找到',
       syncLDAPFailed: '同步 LDAP 用户信息失败',
    ...
    groups: {
      ...
      form: {
        name: '名称',
        sceneName: '场景名',
        sceneNamePlaceholder: '请输入场景名（可选）',
        sceneNameUnset: '未设置场景名',
        description: '描述',
        platform: '平台',
        rateMultiplier: '费率倍数',
        status: '状态',
      ...
      modelRouting: {
        ...
        modelsLoadFailed: '模型加载失败，当前候选无法保存。',
        retryModels: '重试',
        noCommonModels: '所选账号没有共同可用模型。',
        modelInvalid: '原模型已失效，请重新选择。',
        removeCandidate: '删除候选',
          addCandidate: '添加候选',
          scheduleTitle: '分时段并发配置',
          scheduleHint: '每日循环，时间精确到分钟；未覆盖时段使用上方默认最大并发数。',
          scheduleDefaultHint: '未配置分时段，使用默认最大并发数',
          scheduleStart: '开始时间',
          scheduleEnd: '结束时间',
          scheduleLimit: '并发上限',
          scheduleMaxConcurrency: '最大并发',
          scheduleNumeric: '指定数值',
          scheduleUnlimited: '不限制',
          addSchedule: '添加时段',
          removeSchedule: '删除',
          saveSchedules: '保存分时段配置',
          scheduleSaving: '保存中...',
          scheduleSaved: '分时段配置已保存',
          scheduleLoading: '加载分时段配置中...',
          scheduleLoadFailed: '分时段配置加载失败',
          scheduleSaveFailed: '分时段配置保存失败',
          scheduleSaveFailedAfterCreate: '分组已创建，但分时段配置保存失败',
          refreshSchedules: '立即刷新生效配置',
          refreshingSchedules: '刷新任务启动中...',
        refreshStarted: '刷新任务已启动',
        refreshFailed: '刷新任务启动失败',
        refreshAllSchedules: '刷新分时段并发',
        refreshingAllSchedules: '刷新中...',
        refreshAllStarted: '全量刷新任务已启动',
        refreshAllFailed: '刷新分时段并发失败',
        refreshAllSchedulesHint: '立即刷新所有候选的当前生效并发配置',
        effectiveMaxConcurrency: '当前生效最大并发',
        effectiveMaxConcurrencyUnavailable: '暂不可用',
        validation: {
    ...
    accounts: {
      ...
      modelAttributes: {
        title: '模型基本属性（可选）',
        hint: '记录该账户对应模型的基本能力信息（如上下文窗口、是否支持推理/图片输入等），用于管理与查询。可添加预置属性或自定义属性。',
        add: '添加属性',
        custom: '自定义属性',
        empty: '尚未添加任何属性',
        namePlaceholder: '属性名（英文）',
        descriptionPlaceholder: '属性描述（中文）',
        valuePlaceholder: '可填数字、true/false、文本或 JSON 数组',
        remove: '删除该属性',
        duplicateKey: '属性名 {key} 已存在，重复项将被忽略',
        alreadyAdded: '已添加',
        presetLabel: '预置属性（点击快速添加）：',
        presets: {
          contextWindow: '上下文窗口总大小（token）',
          maxOutputTokens: '单次最大输出 token 数',
          supportsReasoning: '是否支持推理模式',
          supportsVision: '是否支持图片输入',
          supportsAudioInput: '是否支持音频输入',
          supportsPdfInput: '是否支持 PDF 输入',
          supportsFunctionCalling: '是否支持函数调用/工具',
          supportsParallelFunctionCalling: '是否支持并行函数调用',
          supportsToolChoice: '是否支持强制工具选择',
          supportsResponseSchema: '是否支持结构化输出（JSON Schema）',
          supportsStreaming: '是否支持原生流式输出',
          supportsPromptCaching: '是否支持 Prompt 缓存',
          supportsSystemMessages: '是否支持系统消息',
          supportsWebSearch: '是否支持联网搜索',
          modalities: '支持的输入模态（text/image/audio/video）',
          maxImagesPerPrompt: '单次提示最多图片数',
          knowledgeCutoff: '知识截止日期（YYYY-MM-DD）',
          notes: '备注'
        }
      },
    ...
    scheduledTests: {
      ...
      createFailed: '创建定时测试计划失败',
      updateFailed: '更新定时测试计划失败',
      deleteFailed: '删除定时测试计划失败',
      loadResultsFailed: '加载测试结果失败',
      results: '测试结果',
      noResults: '暂无测试结果',
      responseText: '响应',
      errorMessage: '错误',
    ...
    usage: {
      ...
      allModels: '全部模型',
      routeAlias: '路由别名',
      searchRouteAliasPlaceholder: '搜索路由别名…',
      allRouteAliases: '全部路由别名',
      allAccounts: '全部账户',
      allGroups: '全部分组',
      allTypes: '全部类型',
      inputCost: '输入成本',
      ...
      departmentUsage: {
          title: '部门 Token 用量',
          description: '按 LDAP 部门查看每日 Token 总量',
          startDate: '开始日期',
          endDate: '结束日期',
          query: '查询',
          loading: '加载中...',
          noData: '所选日期范围暂无部门 Token 数据',
          department: '部门',
          tokens: 'Token',
          user: '用户',
           userCount: '用户数',
           averageTokens: '平均 Token',
           userDetails: '员工 Token 用量',
           refreshUsers: '刷新员工数据',
           noUserData: '所选日期范围暂无员工 Token 数据',
           percent: '占比',
          unset: '未设置',
          syncing: '统计数据仍在同步中（最近同步：{syncedAt}）',
          meta: '最近同步：{syncedAt} · 一致性：{consistency}',
          failed: '部门 Token 用量加载失败'
        },
       sceneUsage: {
         title: '场景 Token 用量',
         description: '按技术分组、场景和账号/上游模型查看每日 Token 总量',
         startDate: '开始日期',
         endDate: '结束日期',
         groupName: '技术分组',
         allGroups: '全部技术分组',
         query: '查询',
         loading: '加载中...',
         noData: '所选日期范围暂无动态统计数据',
         unsetScene: '未设置场景名',
         syncing: '统计数据仍在同步中（最近同步：{syncedAt}）',
         meta: '统计时区：{timezone} · 最近同步：{syncedAt}',
         account: '账号',
         model: '上游模型',
         tokens: 'Token',
         failed: '场景 Token 用量加载失败',
         configHint: '请前往 /admin/token-statistics 配置并启用 group_id + account_id + upstream_model、total_tokens、日统计项。'
       },
