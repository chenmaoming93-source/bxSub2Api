...
const (
	// Label holds the string label denoting the groupcandidatetokendailylimitconfig type in the database.
	Label = "group_candidate_token_daily_limit_config"
	...
	EdgeGroup = "group"
	// Table holds the table name of the groupcandidatetokendailylimitconfig in the database.
	Table = "group_candidate_token_daily_limit_configs"
	// GroupTable is the table that holds the group relation/edge.
	GroupTable = "group_candidate_token_daily_limit_configs"
...
// Columns holds all SQL columns for groupcandidatetokendailylimitconfig fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GroupCandidateTokenDailyLimitConfig queries.
