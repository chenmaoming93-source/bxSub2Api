...
ALTER TABLE api_keys ADD COLUMN IF NOT EXISTS window_5h_start DATETIME(6);
ALTER TABLE api_keys ADD COLUMN IF NOT EXISTS window_1d_start DATETIME(6);
ALTER TABLE api_keys ADD COLUMN IF NOT EXISTS window_7d_start DATETIME(6);
