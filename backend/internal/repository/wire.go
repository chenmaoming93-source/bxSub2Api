...
var ProviderSet = wire.NewSet(
	...
	wire.Bind(new(service.SecurityCheckConfigStore), new(*groupRepository)),
	wire.Bind(new(service.SecurityCheckLogRepository), new(*groupRepository)),
	wire.Bind(new(service.SecurityCheckLogStore), new(*groupRepository)),
	NewUserRepository,
	NewAPIKeyRepository,
	NewGroupRepository,
