export default {
  ...
  auth: {
    ...
    accountPlaceholder: 'Enter email or LDAP username',
  ...
  admin: {
    ...
    users: {
      ...
      failedToLoadApiKeys: 'Failed to load user API keys',
       syncLDAP: 'Sync LDAP user information',
       syncLDAPLoading: 'Syncing LDAP...',
       syncLDAPSuccess: 'LDAP sync completed: {synced}/{total} users synced',
       syncLDAPPartialSuccess: 'LDAP sync completed: {synced}/{total} users synced; {failed} failed or not found',
       syncLDAPFailed: 'Failed to sync LDAP user information',
    ...
    groups: {
      concurrencyView: {
        button: 'View concurrency',
        title: 'Route candidate concurrency',
        candidate: 'Candidate priority',
        empty: 'This group has no model route candidates',
        loadFailed: 'Failed to load concurrency data. Please retry.'
      },
      ...
      form: {
        name: 'Name',
        sceneName: 'Scene Name',
        sceneNamePlaceholder: 'Enter scene name (optional)',
        sceneNameUnset: 'Scene name not set',
        description: 'Description',
        platform: 'Platform',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
      ...
      modelRouting: {
        ...
        modelsLoadFailed: 'Models failed to load; this candidate cannot be saved.',
        retryModels: 'Retry',
        noCommonModels: 'The selected accounts have no common models.',
        modelInvalid: 'The previous model is unavailable. Select another model.',
        removeCandidate: 'Remove Candidate',
        addCandidate: 'Add Candidate',
        scheduleTitle: 'Time-window concurrency',
        scheduleHint: 'Daily recurring windows with minute precision; uncovered minutes use the default limit above.',
        scheduleDefaultHint: 'No time windows configured; using the default maximum concurrency.',
        scheduleStart: 'Start time',
        scheduleEnd: 'End time',
        scheduleLimit: 'Concurrency limit',
        scheduleMaxConcurrency: 'Maximum concurrency',
        scheduleNumeric: 'Specific value',
        scheduleUnlimited: 'Unlimited',
        addSchedule: 'Add window',
        removeSchedule: 'Remove',
        saveSchedules: 'Save time windows',
        scheduleSaving: 'Saving...',
        scheduleSaved: 'Time-window configuration saved',
        scheduleLoading: 'Loading time-window configuration...',
        scheduleLoadFailed: 'Failed to load time-window configuration',
        scheduleSaveFailed: 'Failed to save time-window configuration',
        scheduleSaveFailedAfterCreate: 'The group was created, but time-window configuration failed to save',
        refreshSchedules: 'Refresh effective limits now',
        refreshingSchedules: 'Starting refresh...',
        refreshStarted: 'Refresh task started',
        refreshFailed: 'Failed to start refresh task',
        refreshAllSchedules: 'Refresh scheduled concurrency',
        refreshingAllSchedules: 'Refreshing...',
        refreshAllStarted: 'Full refresh task started',
        refreshAllFailed: 'Failed to refresh scheduled concurrency',
        refreshAllSchedulesHint: 'Immediately refresh effective concurrency for all candidates',
        effectiveMaxConcurrency: 'Current effective maximum',
        effectiveMaxConcurrencyUnavailable: 'Unavailable',
        validation: {
    ...
    accounts: {
      ...
      modelAttributes: {
        title: 'Model Attributes (Optional)',
        hint: 'Record basic capabilities of the model bound to this account (e.g. context window, reasoning / vision support). Used for management and query. Add preset or custom attributes.',
        add: 'Add attribute',
        custom: 'Custom attribute',
        empty: 'No attributes added yet',
        namePlaceholder: 'Attribute name (English)',
        descriptionPlaceholder: 'Attribute description',
        valuePlaceholder: 'Number, true/false, text or JSON array',
        remove: 'Remove this attribute',
        duplicateKey: 'Attribute name {key} already exists; duplicates are ignored',
        alreadyAdded: 'Added',
        presetLabel: 'Presets (click to add):',
        presets: {
          contextWindow: 'Context window size (tokens)',
          maxOutputTokens: 'Max output tokens per request',
          supportsReasoning: 'Supports reasoning mode',
          supportsVision: 'Supports image input',
          supportsAudioInput: 'Supports audio input',
          supportsPdfInput: 'Supports PDF input',
          supportsFunctionCalling: 'Supports function calling / tools',
          supportsParallelFunctionCalling: 'Supports parallel function calling',
          supportsToolChoice: 'Supports forced tool choice',
          supportsResponseSchema: 'Supports structured output (JSON Schema)',
          supportsStreaming: 'Supports native streaming',
          ...
          modalities: 'Supported input modalities (text/image/audio/video)',
          maxImagesPerPrompt: 'Max images per prompt',
          knowledgeCutoff: 'Knowledge cutoff (YYYY-MM-DD)',
          notes: 'Notes'
        }
      },
    ...
    scheduledTests: {
      ...
      createFailed: 'Failed to create scheduled test plan',
      updateFailed: 'Failed to update scheduled test plan',
      deleteFailed: 'Failed to delete scheduled test plan',
      loadResultsFailed: 'Failed to load test results',
    ...
    usage: {
      ...
      routeAlias: 'Route Alias',
      searchRouteAliasPlaceholder: 'Search route alias...',
      allRouteAliases: 'All Route Aliases',
      ...
      departmentUsage: {
          ...
          description: 'View daily Token totals by LDAP department',
          startDate: 'Start date',
          endDate: 'End date',
          query: 'Query',
          loading: 'Loading...',
          noData: 'No department Token data for the selected range',
          department: 'Department',
          tokens: 'Token',
          user: 'User',
           userCount: 'Users',
           averageTokens: 'Avg. Token',
           userDetails: 'Employee Token Usage',
           refreshUsers: 'Refresh employees',
           noUserData: 'No employee Token data for the selected range',
           percent: 'Share',
          unset: 'Not set',
          syncing: 'Statistics are still synchronizing (last sync: {syncedAt})',
          meta: 'Last sync: {syncedAt} · Consistency: {consistency}',
          failed: 'Failed to load department Token usage'
        },
       sceneUsage: {
         title: 'Scene Token Usage',
         description: 'View daily Token totals by technical group, scene, and account/upstream model',
         startDate: 'Start date',
         endDate: 'End date',
         groupName: 'Technical group',
         allGroups: 'All technical groups',
         query: 'Query',
         loading: 'Loading...',
         noData: 'No dynamic statistics for the selected range',
         unsetScene: 'Scene name not set',
         syncing: 'Statistics are still synchronizing (last sync: {syncedAt})',
         meta: 'Statistics timezone: {timezone} · Last sync: {syncedAt}',
         account: 'Account',
         model: 'Upstream model',
         tokens: 'Token',
         failed: 'Failed to load scene Token usage',
         configHint: 'Go to /admin/token-statistics and configure and activate group_id + account_id + upstream_model, total_tokens, and the daily statistic.'
       },
