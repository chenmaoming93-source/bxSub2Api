...
const (
	// Label holds the string label denoting the groupcandidatetokendailyusage type in the database.
	Label = "group_candidate_token_daily_usage"
	...
	EdgeGroup = "group"
	// Table holds the table name of the groupcandidatetokendailyusage in the database.
	Table = "group_candidate_token_daily_usages"
	// GroupTable is the table that holds the group relation/edge.
	GroupTable = "group_candidate_token_daily_usages"
...
// Columns holds all SQL columns for groupcandidatetokendailyusage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GroupCandidateTokenDailyUsage queries.
