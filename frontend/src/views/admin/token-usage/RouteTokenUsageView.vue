      ...
      <div class="flex flex-wrap items-end gap-3">
        ...
        <div>
          ...
          <select v-model="sortBy" class="input text-sm">
            ...
            <option value="group">{{ t('tokenUsageReport.group') }}</option>
            <option value="route_alias">{{ t('tokenUsageReport.route') }}</option>
            <option value="upstream_model">{{ t('tokenUsageReport.upstreamModel') }}</option>
            <option value="priority">{{ t('tokenUsageReport.priority') }}</option>
...
import type { TokenUsageReport, RouteTokenUsageItem, TokenUsageOption, TokenUsageSortField } from '@/api/admin/tokenUsage'
