...
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS rate_limited_at DATETIME(6);
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS rate_limit_reset_at DATETIME(6);
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS overload_until DATETIME(6);
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS session_window_start DATETIME(6);
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS session_window_end DATETIME(6);
