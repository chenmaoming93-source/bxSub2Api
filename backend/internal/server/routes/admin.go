...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers, routes *rbac.RouteRegistrar) {
	groups := admin.Group("/groups")
	{
		...
		adminPOST(routes, groups, "/model-route-references/concurrency-schedules/refresh", rbac.PermissionGroupsUpdate, h.Admin.Group.RefreshAllModelRouteConcurrencySchedules)
		...
		adminGET(routes, groups, "/:id/model-route-concurrency", rbac.PermissionGroupsRead, h.Admin.Group.ListModelRouteConcurrency)
		adminGET(routes, groups, "/:id/model-route-references/concurrency-schedules", rbac.PermissionGroupsRead, h.Admin.Group.ListModelRouteConcurrencySchedules)
		adminPUT(routes, groups, "/:id/model-route-references/concurrency-schedules", rbac.PermissionGroupsUpdate, h.Admin.Group.ReplaceModelRouteConcurrencySchedules)
		adminPOST(routes, groups, "/:id/model-route-references/concurrency-schedules/refresh", rbac.PermissionGroupsUpdate, h.Admin.Group.RefreshModelRouteConcurrencySchedules)
