...
ALTER TABLE accounts ADD COLUMN rate_limited_at DATETIME(6);
ALTER TABLE accounts ADD COLUMN rate_limit_reset_at DATETIME(6);
ALTER TABLE accounts ADD COLUMN overload_until DATETIME(6);
ALTER TABLE accounts ADD COLUMN session_window_start DATETIME(6);
ALTER TABLE accounts ADD COLUMN session_window_end DATETIME(6);
...
CREATE INDEX idx_redeem_codes_group_id ON redeem_codes(group_id);
...
CREATE INDEX idx_usage_logs_billing_type ON usage_logs(billing_type);
